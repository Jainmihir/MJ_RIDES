...
class DriverLogin : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        phonenumber = findViewById(R.id.dr1_phoneEditTextNumber)
        progressBar  = findViewById(R.id.dr1_phoneProgressBar)
        progressBar.visibility = View.INVISIBLE
        btotp = findViewById(R.id.dr1_sendOTPBtn)

        auth = FirebaseAuth.getInstance()
        val data = intent.getStringExtra("phone_number")
        phonenumber.setText(data)
    ...
    private val callbacks = object : PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
        ...
        override fun onCodeSent(
            ...
            val intent = Intent(this@DriverLogin,DriverOtp::class.java)
