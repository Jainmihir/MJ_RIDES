...
class DriverOtp : AppCompatActivity() {
    ...
    private fun init() {
        auth = FirebaseAuth.getInstance()
        verifyBtn = findViewById(R.id.dr2_verifyOTPBtn)
        resendTv = findViewById(R.id.dr2_resendTextView)
        inputOTP1 = findViewById(R.id.dr2_otpEditText1)
        inputOTP2 = findViewById(R.id.dr2_otpEditText2)
        inputOTP3 = findViewById(R.id.dr2_otpEditText3)
        inputOTP4 = findViewById(R.id.dr2_otpEditText4)
        inputOTP5 = findViewById(R.id.dr2_otpEditText5)
        inputOTP6 = findViewById(R.id.dr2_otpEditText6)
        progressBar = findViewById(R.id.dr2_otpProgressBar)
    }
